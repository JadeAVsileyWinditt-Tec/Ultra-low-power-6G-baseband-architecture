//==============================================================================
// dsp_tile_pipeline.sv – DSP tile hosting a multi-stage OFDM FFT pipeline
//==============================================================================
...
module dsp_tile_pipeline #(
  ...
  input  logic [ALU_WIDTH-1:0]       tw_re  [N_STAGES][N_BUTTERFLIES],
  input  logic [ALU_WIDTH-1:0]       tw_im  [N_STAGES][N_BUTTERFLIES],
